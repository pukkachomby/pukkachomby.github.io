...
# Drafts
3. Using Web Browsers (Chrome/Edge/Firefox)
Most modern web browsers (Chrome, Edge, Firefox) have their own built-in PDF viewers. These are often considered safer than desktop apps because they open the document within the browser's sandbox environment, which isolates the file from your computer's main operating system.
...
* air fryer breakfast
    * bacon?  pretty hard to mess that up tbh, although over here we just make ba roi for 30m at 200C
