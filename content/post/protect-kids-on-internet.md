...
It’s essential to talk to kids about using technology responsibly. This includes taking proper precautions to avoid scammers and harmful individuals. For more information, visit [Kids Health: Social Media Smarts](https://kidshealth.org/en/parents/social-media-smarts.html).

## iPhone Parental Controls
To set up parental controls on an iPhone, first enable Family Sharing and add your child to the Family Sharing group.

You can find a variety of options in the [Apple Support guide](https://support.apple.com/en-us/105121), most of which are accessible through the Screen Time app. These features include location sharing, adult site blocking, communication safety, and more.
